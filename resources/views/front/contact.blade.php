  ...
  <div class="w1160 clearfix">
    ...
    <div class="txt_model_7">
      ...
      <script type="text/javascript">
          ...
          //标注点数组
          var markerArr = [{title:"名师教育",content:"座机：{{ session('setting')['fix_phone']  }}<br/>电话：{{ session('setting')['phone']  }}<br/>地址：{{ session('setting')['bases']  }}",point:"{{  explode(',',session('setting')['bases_xy'])[0] }}|{{  explode(',',session('setting')['bases_xy'])[1] }}",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
           ];
          //创建marker
          function addMarker(){
